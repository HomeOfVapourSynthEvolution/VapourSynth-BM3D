...
public:
    ...
    typedef BM3D_Final_Para _Mypara;

public:
    _Myt(const VSAPI *_vsapi = nullptr, std::string _FunctionName = "Final", std::string _NameSpace = "bm3d",
        const _Mypara &_para = BM3D_Final_Default)
        : _Mybase(_vsapi, _FunctionName, _NameSpace, _para, true)
    {}
